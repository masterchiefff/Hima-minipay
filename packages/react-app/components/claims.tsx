  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        ...
        <Button size="sm" className="bg-purple-500 hover:bg-purple-600 h-8 gap-1">
  ...
  return (
    <Card className="bg-black/60 backdrop-blur-sm border border-gray-800 rounded-xl p-3">
      <div className="flex justify-between items-center mb-2">
        ...
        <div className={`flex items-center text-xs py-1 px-2 rounded-full ${getStatusColor()}`}>
          {getStatusIcon()}
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="text-base font-bold text-white">{amount} cKES</div>
      </div>
    </Card>
  )
}
